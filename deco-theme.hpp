...
class decoration_theme_t
{
  ...
  private:
    wf::option_wrapper_t<std::string> font{"wwp-decoration/font"};
    wf::option_wrapper_t<int> title_height{"wwp-decoration/title_height"};
    wf::option_wrapper_t<int> border_size{"wwp-decoration/border_size"};
    wf::option_wrapper_t<wf::color_t> active_color{"wwp-decoration/active_color"};
    wf::option_wrapper_t<wf::color_t> inactive_color{"wwp-decoration/inactive_color"};
};
}
}
